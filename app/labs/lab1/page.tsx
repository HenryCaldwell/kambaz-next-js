  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Breaded chicken cutlets (I can't cook very well):
        <ol id="wd-your-favorite-recipe">
          <li>Toss chicken cutlets in flour.</li>
          <li>Toss chicken cutlets in eggs.</li>
          <li>Toss chicken cutlets in seasoned bread crumbs.</li>
          <li>Heat a frying pan.</li>
          <li>Add a thick layer of olive oil to the frying pan.</li>
          <li>Cook for 3 minutes on medium-high heat.</li>
          <li>Flip and cook the other side.</li>
          <li>Serve and enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Diary of a Wimpy Kid: Dog Days</li>
          <li>Diary of a Wimpy Kid: The Last Straw</li>
          <li>Diary of a Wimpy Kid: Hard Luck</li>
      ...
      <div id="wd-forms">
        ...
        My GitHub
        <a
          href="https://github.com/HenryCaldwell/kambaz-next-js"
          id="wd-github"
        >
          click here
        </a>
